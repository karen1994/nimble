...
INNER JOIN `automóvil` ON `automóvil`.`idTipoVehiculo` = `detenciones`.`idTipoVehiculo` WHERE persona.`idPersona`=".$ConsecutivoP_id;
...
<?php if($Consecutivo != null){?>
  ...
  <br>
      <form name="form1" action="" class="form-horizontal">
        ...
        <h1> Editar persona que retira el automóvil</h1>
              </div>
        </div>
  ...
  <div class="form-group">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="?view=verSalidasAuto" id="btnCancelarPersona" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
      </div>
  </div>
