...
$sql = " SELECT * FROM detenciones INNER JOIN bicicleta ON detenciones.idTipoVehiculo = bicicleta.idTipoVehiculo WHERE detenciones.idDetenciones=".$Consecutivo_id;
...
<?php if($Consecutivo != null){?>
  ...
  <!-- Formulario editar detencion de bicicleta-->
  <div class="container">
  <br>
      <form name="form1" action="" class="form-horizontal">
        ...
        <h1> Editar detención de la bicicleta</h1>
              </div>
        </div>
   ...
   <div class="form-group" style="display:none;">
        <label for="numConsecutivoM" class="control-label col-md-4">Consecutivo de la motocicleta</label>
          <div class="col-md-5">
        <input class="form-control" id="numConsecutivoM" type="text" disabled="" value="<?php echo $Consecutivo->idBicicleta;?>">
          </div>
   </div>
  ...
  <div class="form-group">
       <label for="numMarcoBici" class="control-label col-md-4">Número de marco</label>
         <div class="col-md-5">
       <input class="form-control" id="numMarcoBici" type="text" maxlength="12"  value="<?php echo $Consecutivo->numMarcoBici;?>">
         </div>
  </div>
