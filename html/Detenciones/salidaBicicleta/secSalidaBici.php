...
SELECT * FROM bicicleta INNER JOIN detenciones ON bicicleta.idTipoVehiculo = detenciones.idTipoVehiculo WHERE bicicleta.idBicicleta = ".$Consecutivo_id;
...
<div class="form-group">
    <div class="col-md-8 col-md-offset-3">
      <h1>Formulario salida de detención de bicicleta</h1>
    </div>
</div>

  <div class="form-group">
        <div class="col-md-8 col-md-offset-4">
  <h3>Registrar datos de la salida de la bicicleta</h3>
        </div>
  </div>
