...
INNER JOIN `bicicleta` ON `bicicleta`.`idTipoVehiculo` = `detenciones`.`idTipoVehiculo`
");
?>
...
<tr>
  ...
  <td style="width:150px;"> <!-- Inicia columnas de botones -->
    ...
    <a href="?view=EditarSalidaBici&&id=<?php echo $r['idSalidaDetencion'];?>" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-pencil"></span> Editar salida</a>
  </td>

  <!-- Botón editar persona -->
<td>
  <a href="?view=EditarPeSalBici&&id=<?php echo $r['idPersona'];?>"  class="btn btn-sm btn-success"><span class="glyphicon glyphicon-user"></span> Ver persona</a>
</td>
