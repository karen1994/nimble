...
INNER JOIN motocicleta ON motocicleta.idTipoVehiculo = detenciones.idTipoVehiculo WHERE idSalidaDetencion =".$Consecutivo_id;
...
<?php if($Consecutivo != null){?>
  ...
  <br>
      <form name="form1" action="" class="form-horizontal">
        ...
        <a href="?view=verSalidasMoto" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Regresar</a>
              </div>
        </div>

        <div class="form-group">
              <div class="col-md-8 col-md-offset-3">
        <h1>Editar salida de detención de la motocicleta</h1>
              </div>
        </div>
  ...
  <h3> Datos de salida de la motocicleta</h3>
        </div>
  </div>
  ...
  <div class="form-group">
      <div class="col-md-4 col-md-offset-4">
      <p id="_AJAX_EditSalMoto_"></p>
      </div>
  </div>

  <div class="form-group">
      <div class="col-md-8 col-md-offset-4">
      <a id="btnEditarSalMoto" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a id="btnGuardarEditSalMoto" class="btn btn-primary" style="display:none;"><span class="glyphicon glyphicon-floppy-disk"></span> Guardar cambios</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="?view=verSalidasMoto" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
      </div>
  </div>
