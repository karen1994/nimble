...
$sql = "SELECT * FROM motocicleta INNER JOIN detenciones ON  detenciones.idTipoVehiculo = motocicleta.idTipoVehiculo WHERE idMotocicleta =".$Consecutivo_id;
...
<?php if($Consecutivo != null){?>
  ...
  <br>
     ...
     <h3>Registrar persona que retira la motocicleta</h3>
           </div>
     </div>
...
<div class="form-group" id="btnGuardarDiv" style="display:none;">
   <div class="col-md-4 col-md-offset-4">
  <a  id="btnGuardarSalMoto" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Guardar</a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
