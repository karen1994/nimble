...
INNER JOIN `motocicleta` ON `motocicleta`.`idTipoVehiculo` = `detenciones`.`idTipoVehiculo` WHERE persona.`idPersona`=".$ConsecutivoP_id;
...
<?php if($Consecutivo != null){?>
  ...
  <br>
      <form name="form1" action="" class="form-horizontal">
        ...
        <h1> Editar persona que retira la motocicleta</h1>
              </div>
        </div>
  ...
  <div class="form-group">
      <div class="col-md-4 col-md-offset-4">
      <p id="_AJAX_PersonaSalMoto_"></p>
      </div>
  </div>

  <div class="form-group">
      <div class="col-md-8 col-md-offset-4">
        <a id="btnEditarPersonaMoto" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a id="btnGuardarPersonaMoto" class="btn btn-primary" style="display:none;"><span class="glyphicon glyphicon-floppy-disk"></span> Guardar cambios</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
