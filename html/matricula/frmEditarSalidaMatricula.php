...
<?php if($Consecutivo != null){?>
  ...
  <div class="form-group">
     <label for="oficioSalMatricula" class="control-label col-md-4">Número de oficio</label>
       <div class="col-md-5">
     <input class="form-control" id="oficioSalMatricula" type="text" maxlength="18" placeholder="" disabled="" value="<?php echo $Consecutivo->numOficioPlaca;?>">
       </div>
  </div>
  ...
  <div class="form-group">
    <label for="fecDetMatricula" class="control-label col-md-4">Fecha de salida</label>
      <div class="col-md-5">
    <input class="form-control" id="fecSalMatricula" type="date"  placeholder="" disabled="" value="<?php echo $Consecutivo->fecSalMatricula;?>">
      </div>
  </div>
  ...
  <div class="form-group">
     <label for="tomSalMatricula" class="control-label col-md-4">Tomo</label>
       <div class="col-md-5">
     <input class="form-control" id="tomSalMatricula" type="text" maxlength="4" placeholder="" disabled="" value="<?php echo $Consecutivo->tomSalMatricula;?>">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="folSalMatricula" class="control-label col-md-4">Folio</label>
       <div class="col-md-5">
     <input class="form-control" id="folSalMatricula" type="text" maxlength="4" placeholder="" disabled="" value="<?php echo $Consecutivo->folSalMatricula;?>">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="nomPerCorreo" class="control-label col-md-4">Nombre de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="nomPerCorreo" type="text" maxlength="50" placeholder="" disabled="" value="<?php echo $Consecutivo->nomPersonaEnvia;?>">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="ape1PerCorreo" class="control-label col-md-4">Primer apellido de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="ape1PerCorreo" type="text" maxlength="50"  placeholder="" disabled="" value="<?php echo $Consecutivo->ape1PersonaEnvia;?>">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="ape2PerCorreo" class="control-label col-md-4">Segundo apellido de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="ape2PerCorreo" type="text" maxlength="50" placeholder="" disabled="" value="<?php echo $Consecutivo->ape2PersonaEnvia;?>">
       </div>
  </div>
