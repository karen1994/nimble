...
$sql = "
SELECT * FROM Placa INNER JOIN Motivo ON placa.idMotivo = Motivo.`idMotivo`
...
<?php if($Consecutivo != null){?>
 ...
 <div class="form-group">
      <label for="numBoletaMatricula" class="control-label col-md-4">Número de boleta</label>
        <div class="col-md-5">
      <input class="form-control" id="numBoletaMatricula" type="text" maxlength="15" disabled=""   value="<?php echo $Consecutivo->numBoletaPlaca;?>">
        </div>
 </div>

 <div class="form-group" id="artMo">
   <label for="numArticulo" class="control-label col-md-4">Número de artículo</label>
     <div class="col-md-5">
   <input class="form-control" onfocus="return datosCorrectos()" id="numArticulo" type="text"  maxlength="5" disabled="" value="<?php echo $Consecutivo->numArticulo;?>">
     </div>
 </div>

 <div class="form-group" id="descripMo">
 ...
 <textarea onfocus="return datosCorrectos()" id="desMotivo" rows="8" cols="40" placeholder="Escribe el motivo de la detención"  maxlength="100" disabled=""><?php echo $Consecutivo->descripMotivo;?></textarea>
  ...
  <div class="form-group">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="?view=verMatricula" id="btnCancelarMotivo" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
      </div>
  </div>
