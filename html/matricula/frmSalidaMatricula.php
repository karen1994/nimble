...
<?php if($Consecutivo != null){?>
  ...
  <div class="form-group">
     <label for="oficioSalMatricula" class="control-label col-md-4">Número de oficio</label>
       <div class="col-md-5">
     <input class="form-control" id="oficioSalMatricula" type="text" maxlength="18" placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
    <label for="fecDetMatricula" class="control-label col-md-4">Fecha de salida</label>
      <div class="col-md-5">
    <input class="form-control" id="fecSalMatricula" type="date"  placeholder="" value="">
      </div>
  </div>
  ...
  <div class="form-group">
     <label for="tomSalMatricula" class="control-label col-md-4">Número de tomo</label>
       <div class="col-md-5">
     <input class="form-control" id="tomSalMatricula" type="text" maxlength="4" placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="folSalMatricula" class="control-label col-md-4">Número de folio</label>
       <div class="col-md-5">
     <input class="form-control" id="folSalMatricula" type="text" maxlength="4" placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="nomPerCorreo" class="control-label col-md-4">Nombre de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="nomPerCorreo" type="text" maxlength="50"  placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="ape1PerCorreo" class="control-label col-md-4">Primer apellido de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="ape1PerCorreo" type="text" maxlength="50" placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
     <label for="ape2PerCorreo" class="control-label col-md-4">Segundo apellido de persona del correo</label>
       <div class="col-md-5">
     <input class="form-control" id="ape2PerCorreo" type="text" maxlength="50"  placeholder="">
       </div>
  </div>
  ...
  <div class="form-group">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="#" id="btnCancelarSalMatricula" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
      </div>
  </div>
