...
// Parametros capturados del formulario
  ...
  connect.open('POST','ajax.php?mode=editPeAuto',true); //Abre una conexión con ajax
...
btnGuardarPersona.addEventListener("click", editarPersonaAuto);
