...
// Parametros capturados del formulario
  ...
  connect.open('POST','ajax.php?mode=editMoAuto',true); //Abre una conexión con ajax
...
window.onload= function(){
  ...
  btnGuardarMotivo.addEventListener("click", editarMotivoAuto);
